    ...
    <>
      ...
      <main className="page settings-page">
        <Card>
          {loading && !profile ? (
            ...
            <div className="profile-heading">
              ...
              <div>
                <h2>{shown.display_name || user?.email}</h2>
                <p>
                  {shown.major}
                  {shown.graduation_year
                    ? ` · Class of ${shown.graduation_year}`
                    : ""}
                </p>
              </div>
              <Button
        ...
        <Card>
          ...
          <h3>{shown.university || "University not provided"}</h3>
          <p>
            {shown.major || "Major not provided"}
            {shown.graduation_year || shown.expected_graduation_term
              ? ` · Expected graduation ${[shown.expected_graduation_term, shown.graduation_year].filter(Boolean).join(" ")}`
              : ""}
          </p>
