...
validate(syllabusSchema, { course_code: null, course_title: null, instructor: null, credits: null, meeting_days: null, meeting_start: null, meeting_end: null, location: null, course_summary: "Course", roadmap: [{ period_label: "Week 4", topic: "UI Design & Accessibility", description: null, deliverable: "Assignment 1 due", date: null }, { period_label: null, topic: "No deliverable mentioned", description: null, date: null }], assignments: [{ title: "Work", description: null, due_at: "2026-09-01T00:00:00Z", estimated_minutes: 45 }, { title: "No estimate given", description: null, due_at: null }], exams: [{ title: "Midterm", exam_at: "2026-10-01T00:00:00Z", location: "Room 101", topics_summary: "Chapters 1-4" }, { title: "No location or summary given", exam_at: null }] })
if (normalizeSyllabusResult({ roadmap: [], assignments: [{ title: "Undated work", description: null, due_at: null, estimated_minutes: null }], exams: [] }).assignments.length !== 0) throw new Error("normalizeSyllabusResult must demote undated assignments to roadmap entries")
...
validate(degreeAuditSchema, { document_type: "personal_audit", university: "University", major: "Computer Science", catalog_year: 2025, total_credits_required: 120, total_credits_completed: 88, courses: [], requirements: [{ requirement_label: "CSCE Breadth Choices", status: "in_progress", credits_required: 6, credits_completed: 3, credits_remaining: 3, required_course_codes: [], applied_courses: [{ course_code: "CSCE 4000", credits_applied: 3 }], choice_requirement_text: "Breadth choice", details: null }] })
validate(degreeAuditSchema, { document_type: "program_guide", university: "University of North Texas", major: "B.S. Computer Science", catalog_year: 2025, total_credits_required: 120, total_credits_completed: null, courses: [], requirements: [{ requirement_label: "Computer Science Required Courses", status: "unclear", credits_required: 40, credits_completed: null, credits_remaining: null, required_course_codes: ["CSCE 1010"], applied_courses: [], choice_requirement_text: null, details: "Year 1, Fall" }] })
